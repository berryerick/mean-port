 ...
 * See our [query casting post](/docs/posts/query_casting.html) for
 ...
 * @see query casting /docs/posts/query_casting.html
 * @api public
 */
 ...
 * @return {Query}
 * @see field selection #query_Query-select
 * @see lean queries /docs/posts/lean.html
 * @see findById in Mongoose https://masteringjs.io/posts/mongoose/find-by-id
 * @api public
 */
 ...
 *
 * If `options.out` is set to `replace`, `merge`, or `reduce`, a Model instance is returned that can be used for further querying. Queries run against this model are all executed with the [`lean` option](/docs/posts/lean.html); meaning only the js object is returned and no Mongoose magic is applied (getters, setters, etc).
 *
 * ####Example:
 *
 *     const o = {};
 ...
 * - [An Introduction to Mongoose Aggregate](https://masteringjs.io/posts/mongoose/aggregate)
 ...
 * @param {Object|Boolean} [options.lean] if truthy, mongoose will return the document as a plain JavaScript object rather than a mongoose document. See [`Query.lean()`](/docs/api.html#query_Query-lean) and the [Mongoose lean post](/docs/posts/lean.html).
 * @param {Function} [callback] optional callback
 * @return {Promise}
