 ...
 * to exclude (which implies all other fields are included). The [`_id` field is the only exception because MongoDB includes it by default](https://docs.mongodb.com/manual/post/project-fields-from-query-results/#suppress-id-field).
 *
 * ####Example
 *
...
/**
 * Returns the current query filter (also known as conditions) as a [POJO](https://masteringjs.io/posts/fundamentals/pojo).
 *
 * ####Example:
 *
 *     const query = new Query();
 ...
 *
 * [Lean is great for high-performance, read-only cases](/docs/posts/lean.html),
 ...
 * @param {Object} [options.lean] if truthy, mongoose will return the document as a plain JavaScript object rather than a mongoose document. See [`Query.lean()`](/docs/api.html#query_Query-lean) and [the Mongoose lean post](/docs/posts/lean.html).
 * @param {ClientSession} [options.session=null] The session associated with this query. See [transactions docs](/docs/transactions.html).
 * @param {Boolean|String} [options.strict] overwrites the schema's [strict mode option](http://mongoosejs.com/docs/guide.html#strict)
 ...
 * @see Post /docs/posts/findoneandupdate.html
 ...
 *
 * _All paths passed that are not [atomic](https://docs.mongodb.com/manual/post/model-data-for-atomic-operations/#pattern) operations will become `$set` ops._
 *
 * This function triggers the following middleware.
 *
 * - `update()`
 ...
 *
 *     // keys that are not [atomic](https://docs.mongodb.com/manual/post/model-data-for-atomic-operations/#pattern) ops become `$set`.
 ...
 * - Use `replaceOne()` if you want to overwrite an entire document rather than using [atomic](https://docs.mongodb.com/manual/post/model-data-for-atomic-operations/#pattern) operators like `$set`.
 *
 ...
 * not accept any [atomic](https://docs.mongodb.com/manual/post/model-data-for-atomic-operations/#pattern) operators (`$set`, etc.)
 *
 ...
 *
 * More about [`then()` in JavaScript](https://masteringjs.io/posts/fundamentals/then).
 *
 ...
 *
 * More about [Promise `catch()` in JavaScript](https://masteringjs.io/posts/fundamentals/catch).
 *
 * @param {Function} [reject]
 * @return {Promise}
 * @api public
 ...
 * @param {Object|Function} [options.match=null] Add an additional filter to the populate query. Can be a filter object containing [MongoDB query syntax](https://docs.mongodb.com/manual/post/query-documents/), or a function that returns a filter object.
 ...
 * @see tailable http://docs.mongodb.org/manual/post/create-tailable-cursor/
 * @api public
 */
