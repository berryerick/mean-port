 ...
 * @param {Function} [obj.validator] validator function. If the validator function returns `undefined` or a truthy value, validation succeeds. If it returns [falsy](https://masteringjs.io/posts/fundamentals/falsy) (except `undefined`) or throws an error, validation fails.
