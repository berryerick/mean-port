declare module 'mongoose' {
  ...
  class Connection extends events.EventEmitter {
    ...
    /**
     * A [POJO](https://masteringjs.io/posts/fundamentals/pojo) containing
  ...
  class Document<T = any> {
    ...
    /** Converts this document into a plain-old JavaScript object ([POJO](https://masteringjs.io/posts/fundamentals/pojo)). */
  ...
  interface SchemaTypeOptions<T> {
    ...
    /**
     * If [truthy](https://masteringjs.io/posts/fundamentals/truthy), Mongoose will
     * build an index on this path when the model is compiled.
     */
    index?: boolean | number | IndexOptions;

    /**
     * If [truthy](https://masteringjs.io/posts/fundamentals/truthy), Mongoose
  ...
  class Aggregate<R> {
    ...
    /**
     * Helper for [Atlas Text Search](https://docs.atlas.mongodb.com/reference/atlas-search/post/)'s
     * `$search` stage.
     */
