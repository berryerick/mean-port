 ...
 * docs(query): link to lean, findOneAndUpdate, query casting posts from query docs #9410
 ...
 * docs: fix broken anchor links on validation post #7966
 ...
 * docs(posts): add virtuals post #7965
 ...
 * docs: add getters/setters post #7919
 ...
 * docs(posts): add post about custom casting functions #7045
 ...
 * docs(posts): add findOneAndUpdate() post #7847
 ...
 * docs(posts): add query casting post #7789
...
5.4.20 / 2019-03-25
===================
 * docs(posts): add post about `lean()` #7640
 ...
 * docs(posts): add "Working With Dates" post #7597
